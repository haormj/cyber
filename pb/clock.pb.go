...
type Clock struct {
	...
	Clock *uint64 `protobuf:"varint,1,req,name=clock" json:"clock,omitempty"`
}
...
func (x *Clock) GetClock() uint64 {
	if x != nil && x.Clock != nil {
		return *x.Clock
	}
	return 0
}
...
var file_clock_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x63, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x61,
	0x70, 0x6f, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x79, 0x62, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x22, 0x1d, 0x0a, 0x05, 0x43, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6c,
	0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20, 0x02, 0x28, 0x04, 0x52, 0x05, 0x63, 0x6c, 0x6f, 0x63, 0x6b,
...
var file_clock_proto_goTypes = []interface{}{
	(*Clock)(nil), // 0: apollo.cyber.proto.Clock
}
