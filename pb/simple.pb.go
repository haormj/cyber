...
func (x *SimpleMessage) GetInteger() int32 {
...
type SimpleRepeatedMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Message []*SimpleMessage `protobuf:"bytes,1,rep,name=message" json:"message,omitempty"`
}

func (x *SimpleRepeatedMessage) Reset() {
	*x = SimpleRepeatedMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *SimpleRepeatedMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimpleRepeatedMessage) ProtoMessage() {}

func (x *SimpleRepeatedMessage) ProtoReflect() protoreflect.Message {
	mi := &file_simple_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SimpleRepeatedMessage.ProtoReflect.Descriptor instead.
func (*SimpleRepeatedMessage) Descriptor() ([]byte, []int) {
	return file_simple_proto_rawDescGZIP(), []int{1}
}

func (x *SimpleRepeatedMessage) GetMessage() []*SimpleMessage {
	if x != nil {
		return x.Message
	}
	return nil
...
var file_simple_proto_rawDesc = []byte{
	,
}
...
var file_simple_proto_goTypes = []interface{}{
	(*SimpleMessage)(nil),         // 0: apollo.cyber.proto.SimpleMessage
	(*SimpleRepeatedMessage)(nil), // 1: apollo.cyber.proto.SimpleRepeatedMessage
}
var file_simple_proto_depIdxs = []int32{
	0, // 0: apollo.cyber.proto.SimpleRepeatedMessage.message:type_name -> apollo.cyber.proto.SimpleMessage
...
func file_simple_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_simple_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SimpleRepeatedMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
