...
type Config struct {
	...
	ChannelName *string `protobuf:"bytes,1,req,name=channel_name,json=channelName" json:"channel_name,omitempty"`
}
...
func (x *Config) GetChannelName() string {
...
var file_proto_config_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2b, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x21,
	...
	0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62,
}
